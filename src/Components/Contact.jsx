...
function Contact() {
    return (
        <>
            <h1 data-aos="fade" data-aos-once="true" style={{color: "white", textAlign: "center", margin: "-50px 0px 60px 0px", textShadow: "white 1px 0 15px", fontSize: "3rem"}}>Contactanos</h1>
                <div id='contact' className='Contact-container'>
            <div data-aos="fade-down" data-aos-once="true" data-aos-duration="600" data-aos-delay="200"  className='Contact-element m-3'>
            ...
            <div data-aos="fade-down" data-aos-once="true" data-aos-duration="600" data-aos-delay="300" className='Contact-element m-3'>
                <div className='Contact-img'>
            ...
            <div data-aos="fade-down" data-aos-once="true" data-aos-duration="600" data-aos-delay="400" className='Contact-element m-3'>
                <div className='Contact-img'>
