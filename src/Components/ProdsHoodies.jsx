            ...
            <ScrollToTop />
            {
                cargando
                    ...
                    <div style={{ margin: "auto" }} className='filter_spinner_container'>
                        ...
                        <p className='filter_spinner_text'>Cargando hoodies...</p>
                    </div>
                    :
                    <>
                        {
                            <>
                                ...
                                <div className='Category-section'>
                                    <h1 data-aos="fade" data-aos-once="true" style={{ color: "white", textAlign: "center", textShadow: "white 1px 0 15px", fontSize: "3rem" }}>Hoodies</h1>
                                ...
                                <div className='Catalogo-container'>
                                    {filter.map((prod) => {
                                        return prod.categoria === "Hoodies oversize frisado" && (
                                            <>
